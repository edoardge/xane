...
Decoration {
    function readBorderSize() {
        ...
        case DecorationOptions.BorderNoSides:
            ...
            borders.setSideBorders(3);
            extendedBorders.setSideBorders(0);
            break;
        case DecorationOptions.BorderNone:
            borders.setBorders(3);
            extendedBorders.setBorders(0);
            break;
    ...
    property bool titleShadow: false
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                color: colorHelper.shade(root.titleBarColor, ColorHelper.DarkShade, colorHelper.contrast - (decoration.client.active ? 0.01 : 0.01))
            }
        }
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop {
                    position: 0.0
                    color: colorHelper.shade(root.titleBarColor, ColorHelper.MidlightShade, colorHelper.contrast - 0.01)
                }
                GradientStop {
                    id: middleGradientStop
                    position: 0.01/(decoration.client.maximized ? top.maximizedHeight : top.normalHeight)
                    color: colorHelper.shade(root.titleBarColor, ColorHelper.MidShade, colorHelper.contrast - 0.01)
                }
                GradientStop {
                    position: 0.01
                    color: root.titleBarColor
            ...
            Item {
                ...
                anchors {
                    ...
                    right: parent.right
                    top: parent.top
                    topMargin: decoration.client.maximized ? 4 : titleRow.topMargin
    ...
    Component {
        ...
        Button {
            ...
            height: root.buttonSize
            image: "imgs/help.svg"
            imageHover: "imgs/help_hover.svg"
            imageDisable: "imgs/keepAbove_disable.svg"
